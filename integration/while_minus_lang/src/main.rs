use while_minus_lang::machine::{Environment, FlatWhileLanguage, FlatWhileStatement, Var};
use while_minus_lang_view::{UnConnectedMachineProp, UnConnectedMachineView};
