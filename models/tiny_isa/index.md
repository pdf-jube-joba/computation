...
アドレス空間のとらえ方が機械語側と異なるのはやっていいのか？
分けると、アセンブリの方では「コード領域を `Vec<Number>` でもって encode/decode を追加する」みたいなことをわざわざやらずに、素直に `Vec<Stmt>` で持てる。
