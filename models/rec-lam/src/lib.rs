...
impl Compiler for Rec2LamCompiler {
    ...
    fn decode_routput(
        output: <<Self as Compiler>::Target as utils::Machine>::ROutput,
    ) -> Result<<<Self as Compiler>::Source as utils::Machine>::ROutput, String> {
        let _: () = output;
        Ok(())
    }

    fn decode_foutput(
        output: <<Self as Compiler>::Target as utils::Machine>::FOutput,
    ) -> Result<<<Self as Compiler>::Source as utils::Machine>::FOutput, String> {
